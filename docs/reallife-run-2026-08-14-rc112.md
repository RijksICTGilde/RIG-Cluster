...
| 2 | `f56433a9` | `pytest -m reallife` | zie hieronder | |
| 2 | `f56433a9` | `pytest -m punt14` (30 rondes x 2 vormen) | zie hieronder | |

De twee suites liepen in ronde 2 **gelijktijdig**, zodat de punt-14-jacht werkelijke
belasting op de ProjectStore had en niet op een stil cluster meette.

## Punt 14: het oordeel

**Niet gereproduceerd, in 76 gerichte pogingen, waarvan de helft onder belasting.**
...
2. **Gelijktijdig** (de scherpste): laat twee componentpatches NOG lopen terwijl de
   ...
   projectbestand.
3. **Zonder wachten**: het paar afvuren zonder de eerste taak af te wachten. Ook dit
...
De reproductie ontbreekt nog aan een ding dat wij niet konden nabootsen: de zad-cli
draaide een volledig draaiboek van 44 stappen, met echte uitrol en dus met taken die
minuten duren. Wij hebben `rollout=false` gebruikt (zoals punt 14 beschrijft), waardoor
elke taak in seconden klaar is en het venster waarin twee schrijvers elkaar raken veel
kleiner is. Een volgende poging zou het draaiboek met uitrol AAN moeten draaien en
tegelijk componentpatches moeten afvuren.
...
| 4 | `test_ui_removal_while_api_patches_same_file` blijft xfail | **Code, bekend** -- een component uit de modal halen laat zijn verwijzing in de deployment staan; staat al als strict xfail met uitleg |
