...
The port help text carries the two pitfalls from the design (2.5): it is the port of the
RECEIVING side, and an authorization-wall makes that 4180 rather than the app port.
"""
...
OUTBOUND_PEER_DEPLOYMENT = EditableVisualizer(
    ...
    help_text="Welke deployment van dat project. Leeglaten kan op projectniveau; elke deployment vult hem dan zelf in.",
)
